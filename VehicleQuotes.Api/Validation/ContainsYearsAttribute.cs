...
public class ContainsYearsAttribute: ValidationAttribute
{
    ...
    // The framework calls this constructor when the validation attribute is applied to some member. In this specific
    ...
    protected override ValidationResult IsValid(object value, ValidationContext validationContext)
    {
        ...
        // attribute to work on optional fields. In order words, this attribute will skip validation if there is no 
        // value to validate.
        if (value != null)
        {
    ...
    //Determines if a given value is valid by making sure it's not null, not empty, that its length is 4 and that
